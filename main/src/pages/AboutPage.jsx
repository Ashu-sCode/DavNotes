...
export default function AboutPage() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Quickly download any resource with one click for offline study.",
    },
    {
  ...
  const jsonLdOrganization = {
    ...
    description:
      "DavNotes is a student-focused platform providing semester-wise notes, previous year question papers, assignments, and syllabus for easy access and organized studying.",
    founder: {
      "@type": "Person",
      name: "Ashutosh",
  ...
  const howToJsonLd = {
    ...
    description:
      "Step-by-step guide to browse and download notes, PYQs, assignments, and syllabus on DavNotes.",
    step: [
      {
        "@type": "HowToStep",
        name: "Select Program",
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-24 pb-16">
      ...
      <meta
        property="og:title"
        content="About DavNotes | Student Resource Platform"
      />
      <meta
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          DavNotes is a student-focused platform designed to help students
          easily access notes, previous year question papers, assignments, and
          syllabus. Our goal is to make studying organized, simple, and
          effective.
        </p>
      </motion.div>
      ...
      >
        <h2 className="text-2xl font-bold mb-4 dark:text-gray-50">
          About the Creator
        </h2>
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          This platform is created by{" "}
          <span className="font-medium">Ashutosh</span>, a BCA 3rd-year student
          (2025-26 batch) in Dav College 10 Chandigarh, passionate about
          building educational tools for students. The goal is to make learning
          resources easily accessible and well-organized.
        </p>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {contributors.map((c, i) => (
            <div
              key={i}
              className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md hover:shadow-xl transition flex flex-col items-center"
            >
              <img
                src={c.avatar}
                alt={c.name}
              ...
              />
              <h3 className="font-semibold text-lg dark:text-gray-50">
                {c.name}
              </h3>
              <p className="text-gray-600 dark:text-gray-300 mb-2">{c.role}</p>
              <a
                href={c.profile}
                target="_blank"
                rel="noopener noreferrer"
